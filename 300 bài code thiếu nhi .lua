...
local Window = Fluent:CreateWindow({
    Title = "Cụt Chim Hub",
    SubTitle = "Blox Kid|làm bởi fan a Dyrian gửi tặng(Nguyen Tran-man vu)",
    TabWidth = 160,
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local SliderHealt = Tabs.Main:AddSlider("SliderHealt", {
        Title = "Máu của Quái",
        Description = "Đặt số % máu để cày thông thạo",
        Default = 25,
        Min = 0,
        Max = 100,
        Rounding = 1,
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Di chuyển đến đảo Kitsune", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Thu Thập Azure Embers", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Tự Động Mua thuyền", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = " Giết TerroShark", Default = false })
...
Tabs.Teleport:AddButton({
    Title = "Dịch chuyển đến biển 1",
    Description = "Trở về quê hương đầy ăn xin",
    Callback = function()
...
Tabs.Teleport:AddButton({
    Title = "Dịch chuyển đến biển 2",
    Description = "Khởi Đầu của hành trình skibidi toilet",
    Callback = function()
...
Tabs.Teleport:AddButton({
    Title = "Dịch chuyển đến biển 3",
    Description = "Vễ suối vàng",
    Callback = function()
...
Tabs.Raid:AddButton({
    Title = "Raid Lab",
    Description = "Chỗ đi raid trái ác quỷ lên v2",
    Callback = function()
...
Tabs.Race:AddButton({
    Title = "Gạt Cần",
    Description = "Gạt cần mở cửa chỗ up v4",
    Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Nhảy cao",
	Description = "học để bay lên như một vị tinh tú",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Haki Vũ trang",
	Description = "Học Haki đẻ sở hữu nigga aura",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Flash Step",
	Description = "Mua xong bấm R để di chuyển nhanh hơn",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Black Leg",
	Description = "Khởi đầu của melee sigma",
	Callback = function()
...
Tabs.Shop:AddButton({
	...
	Description = "cho nhx ae sea 1 dùng",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Dragon Claw",
	Description = "cho nhx sea 2 dùng",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Superhuman",
	Description = "Cho mấy anh dân skill build (dân war combo)",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Dragon Talon",
	Description = "Ngậy ko kém godhuman",
	Callback = function()
...
Tabs.Shop:AddButton({
	...
	Description = "Hoàn Lại chỉ số nếu ko thích dùng chỉ số cũ",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Đổi tộc",
	Description = "Chơi Nhân Phẩn tốn 3k fragment",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Vào Đội Hải Tặc",
	Description = "Team Luôn Đc chọn",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Vào Đội Hải Quân",
	Description = "Team Phả diện =))",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = " Trái ác quỷ Shop Menu",
	Description = "Xem Trái ác nào bán ",
	Callback = function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
Tabs.Misc:AddButton({
	...
	Description = "Xem Danh hiệu của bạn đạt đc",
	Callback = function()
		local args = {
			[1] = "getTitles"
		}
...
Tabs.Misc:AddButton({
	Title = "Mưa Trái ác gủy",
	Description = "Cơn mưa trái (Fake)",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Show Items",
	Description = "show nhx thứ béo ngậy nhất của acc",
	Callback = function()
		do
...
Tabs.Misc:AddButton({
	Title = "Xóa sương mù",
	Description = "dùng khi tìm đảo bí ẩn",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "luôn luôn buổi sáng",
	Description = "ko ngon đâu đừng dùng",
	Callback = function()
