...
--test script 
    Title = "Dyrian Hub",
    SubTitle = "Version 1|By Dyrian đz vào kênh a để ủng hộ nhé https://www.youtube.com/@dyydeptry",
    TabWidth = 160,
...
local listfastattack = {'Đánh Thường','Đánh Nhanh','Đánh Siêu Nhanh'}

    local DropdownDelayAttack = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        Title = "Chọn Tốc Độ đánh(NÊN dùng Fast attack vì đang cs ban) ",
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Tự đông cày level", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Đánh các con quái xung quanh", Default = false })
    ...
    spawn(function()
      ...
      Tabs.Main:AddButton({
        Title = "Đổi thưởng Tất cả Mã",
        Description = "Đổi thưởng mã siêu béo",
        Callback = function()
            UseCode()
        end
    })
    ...
    Tabs.Main:AddButton({
        Title = "Tăng Fps",
        Description = "Tăng Fps Cho nhx ae máy yếu",
        Callback = function()
            FPSBooster()
        end
    })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local SliderHealt = Tabs.Main:AddSlider("SliderHealt", {
        Title = "Chọn Phần (%) Máu",
        Description = "Để Cày thông Thạo Súng VÀ Trái",
        Default = 25,
        Min = 0,
        Max = 100,
        Rounding = 1,
...
if Third_Sea then
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Tự Động Cày Xương", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Tự Động Cày Nguyên Liệu", Default = false })
...
if Third_Sea then
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Tự Động Đánh Boss Elite Hunter", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Tự Động Đánh Vua Biển", Default = false })
...
local ToggleTweenMirageIsland = Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Di chuyển tới Đảo Bí Ẩn ", Default = false })
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Di chuyển tới bánh răng gạt cần", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Khóa Tầm nhìn vào mặt trăng và bật tộc v3", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tự động tìm đảo Bí Ẩn", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Tự động lấy kiếm lưỡi hái tử thần [Đầy đủ]", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Tự động lấy kiếm Yama", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Tự động lấy kiếm tushita ", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Tự Đông Châm lủa Đuốc Thánh để lấy kiếm tushita", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Đánh Vua Bột [Cần Chiệu Hồi]", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Mua Màu Haki",Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Loại Bỏ Thông báo Sát thương", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Loại Bỏ Hết Thông Báo", Default = false })
...
Tabs.Teleport:AddButton({
    Title = "Biển 2",
    Description = "Hành Trình Của Sigma skibid rizz",
    Callback = function()
...
Tabs.Teleport:AddButton({
    Title = "Biển 3",
    Description = "Hành Trình Cuối Cùng",
    Callback = function()
...
if Second_Sea then
Tabs.Raid:AddButton({
    Title = "Tập Kích Up trái v2 ở sea 2",
    Description = "Raid up trái lên v2",
    Callback = function()
...
elseif Third_Sea then
    Tabs.Raid:AddButton({
        Title = "Tập Kích Up trái v2 ở sea 3",
        Description = "Raid up trái lên v2",
        Callback = function()
...
Tabs.Race:AddButton({
    Title = "Gạt Cần",
    Description = "dịch chuyển đến chỗ gạt cần",
    Callback = function()
...
Tabs.Race:AddButton({
    Title = "Cửa Up Tộc v4",
    Description = "dịch chuyển đến cửa up tộc v4",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875) 
        wait(0.1)
           Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875) 
...
Tabs.Shop:AddButton({
	Title = "Nhảy Cao",
	Description = "Học Để có thể Bay lên như một vi tinh tú",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Haki Vũ Trang",
	Description = "Để Hóa Thành Aura Của Nô lệ Da đen",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Flash Step",
	Description = "Mua Để tele Như the flash",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Black Leg",
	Description = "Khởi Đầu Của Huyền Thoại",
	Callback = function()
...
Tabs.Shop:AddButton({
	...
	Description = "Cxng ok Để farm ở sea 2",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Electric Claw",
	Description = "Out Meta nhx vẫn ngon vl",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Dragon Talon",
	Description = "Noon Bá Cháy Bọ Chét nhx ko bằng Godhuman",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Godhuman",
	Description = "Top 1 melee siêu ngon",
	Callback = function()
...
Tabs.Misc:AddButton({
	...
	Description = "Mua Nhx trái cháy như fifai",
	Callback = function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
Tabs.Misc:AddButton({
	Title = "Màu Haki",
	Description = "ad xóa r bấm vào chỉ hiện menu cũ thôi",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Mở Thức tỉnh",
	Description = "Thức Tỉnh Trái (ko bt cs phải ko tét đi)",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Mưa Trái ác quỷ ff",
	Description = "Cơn Mưa Cứt (Fake)",
	Callback = function()
